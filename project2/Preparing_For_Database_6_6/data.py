...
def shape_element(element):
    ...
    #  Process of tags "node" and "way".
    if element.tag == "node" or element.tag == "way" :
        
        # Attributes id and tag type, visible of "node" and "way" are added to dictionary node.
        node["id"] = element.attrib["id"]
        node["type"] = element.tag
        if "visible" in element.attrib:
            node["visible"] = element.attrib["visible"]
        
        # Elements in the CREATED array are added in dictionary "created".
        for i in CREATED:
        ...
        # Latitude and longitude for node node are added as floats to a array named "pos". 
